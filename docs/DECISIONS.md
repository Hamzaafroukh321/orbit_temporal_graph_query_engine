...
The implemented language is intentionally small but exercises production store/query boundaries. Full semantic binding, parameter typing, and broader parallel operator coverage remain pending.
